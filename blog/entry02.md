...
## Content:
After I did my research I have learned that there are many unique softwares and hardwares that is accesible to apsiring writers all around the world. For example, one software was an app called Scrivener which I found after searching "Writing apps", this app has many different tools you can use such as publishing and exporting your writing, it can make simple corrections or restruct all your paragaphs so its better organized. Also, it can track amoutn of times you use certain words, that helps you make sure you aren´t reusing words often, and if so, you can make substitutions. Another website I found after searching "What are some software that writers use for writing?" was a website known as Dabblewriter. This app allows you to map out every arc in your story so its easier for you to remember, understand. and then incoporate into the story. In additon the app can read your paragraphs to you, in order to help correct your phrasing and catch mistakes.
