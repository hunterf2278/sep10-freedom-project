...
## Content:
My tool was Aframe which is a 3d design based tool. You can make 3d shapes such as a cube, triangle, sphere, and cylinder. You can also stack these shapes on top of eachother to  create your own  image or creation. For instance, this is an example of some of my shapes:
...
Next, I learned that I can make animations and depending on the numbers in the code, that will determine how exaggerated an animation is. If the number is 2.2 then the animation will be smaller, if its 5.5 then it will be bigger.  The code below shows the different animation numbers of my two boxes: 
